...
Revision ID: 49a9fa87fb13
Revises: ef874f485cd5
Create Date: 2026-03-07 08:02:35.232394
...
revision: str = '49a9fa87fb13'
down_revision: Union[str, Sequence[str], None] = 'ef874f485cd5'
...
def upgrade() -> None:
    ...
    op.add_column('posts', sa.Column('contents', sqlmodel.sql.sqltypes.AutoString(), nullable=False))
